package me.yukuixing.dubbo.config;
...
@MapperScan(
        basePackages = "me.yukuixing.dubbo.dao.master",
...
public class DataSourceConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(
            @Qualifier("masterDataSource") DataSource dataSource,
            @Value("${mybatis.internal.mapperLocations}") String mapperLocations)
            throws Exception {
    ...
    @Configuration
    @MapperScan(
            basePackages = "me.yukuixing.dubbo.dao.slave",
